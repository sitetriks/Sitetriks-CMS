...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _common_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common/data.js */ "./scripts/common/data.js");
/* harmony import */ var _common_loader_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./common/loader.js */ "./scripts/common/loader.js");
...
var homepageDesktopFuncTionality = function () {
  ...
  var drawSnowflakeGlobal = function () {
    ...
    function GetLine(width, points, customClass) {
      ...
      for (var i = 0; i < points.length; i += 1) {
        ...
        var line = $('<div>').addClass(customClass) // .addClass('line' + LineIndex)            
    ...
    var drawSnowflake = function drawSnowflake(halfwidth, elementSizeBase, parentDevider) {
      ...
      var tenThirty = [radialToXY(0 * halfwidth, 0, halfwidth, halfwidth), radialToXY(0.5 * halfwidth, 135, halfwidth, halfwidth)]; // smaller lines
  ...
  var moveToMiddleMenuIcon = function moveToMiddleMenuIcon() {
    ...
    function scrollcb(target) {
      var targetclass = target.className.split(' ')[1]; // find the corresponding element

      var $targetIcon; //  $targetIcon = $(`#${targetclass}`);

      $targetIcon = $('#' + targetclass);
      var scrollDistance = $targetIcon.offset().top - 125; // scroll to the element
...
var mobileMenuFunctionality = function () {
  ...
  var enterpriseFeaturesMenu = function enterpriseFeaturesMenu() {
    $('.wrapper-menu-items').on('click', $('.item-header'), function (event) {
      var button = $(event.target); //$('.item-arrow').toggle();
  ...
  var removeMobileMenu = function removeMobileMenu() {
    ...
    if (windowWidth > 767 && windowHeight > 620) {
      $('#mobile-view-top-menu').css('display', 'none'); // $('.hidden-by-menu').css('display', 'block');
...
var bottomMenuFunctionality = function () {
  ...
  var changeMenu = function changeMenu() {
    ...
    if (windowWidth < 768) {
      _common_loader_js__WEBPACK_IMPORTED_MODULE_1__["Blur"].remove();
  ...
  var loadDefaultBottomMenu = function loadDefaultBottomMenu(url) {
    _common_data_js__WEBPACK_IMPORTED_MODULE_0__["Data"].getJson({
      url: '/sitetriks/display/GetPageString?pageUrl=' + url
    }).then(function (res) {
      if (res.success) {
...
$(document).ready(function () {
  ...
  attachReadMoreHandler(); //   attachTermsAndContidionsHandlers();
});
$(document).ready(function () {
  ...
  mobileMenuFunctionality.enterpriseFeaturesMenu(); //   moveToMiddleMenuIcon();
});
$(window).scroll(homepageDesktopFuncTionality.resizeBlueNavbar);
$(window).ready(homepageDesktopFuncTionality.moveToMiddleMenuIcon); //$(window).ready(homepageDesktopFuncTionality.redrawSnowflakeGlobal.reDrawSnowflake);
