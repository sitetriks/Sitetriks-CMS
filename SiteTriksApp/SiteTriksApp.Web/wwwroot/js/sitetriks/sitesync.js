/* globals Data Notifier */

var siteSyncModule = (function () {
    function init(siteSyncModel, siteSyncCore, connectToTargetUrl, postSyncUrl) {
        ...
        function deleteTarget() {
            ...
            Data.postJson({ url: url }).then(function (res) {
            }).then(function () {
                $targetSelect.val(0);
