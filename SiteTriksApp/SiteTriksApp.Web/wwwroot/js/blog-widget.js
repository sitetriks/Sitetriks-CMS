/* globals Data, Loader, Utils, Pager, DataSource, HashRouter, Comments, Validator */
...
(function () {
    ...
    let $container = $wrapper.find('.blog-container');
    ...
    function loadDependencies() {
        ...
        if (typeof Pager === 'undefined') {
            promises.push(Utils.loadjscssfileAsync('/js/modules/pager.js', 'js'));
        }

        if (typeof DataSource === 'undefined') {
            promises.push(Utils.loadjscssfileAsync('/js/modules/data-source.js', 'js'));
        }

        if (typeof Handlebars === 'undefined') {
            promises.push(Utils.loadjscssfileAsync('/lib/custom/handlebars/handlebars-v4.0.11.js', 'js'));
        }
        ...
        if (typeof textEditor === 'undefined') {
            promises.push(Utils.loadjscssfileAsync('/js/text-editor.js', 'js'));
        }

        if (typeof Comments === 'undefined') {
            promises.push(Utils.loadjscssfileAsync('/js/comments.js', 'js'));
        }
    ...
    function bindEvents() {
        ...
        $wrapper.on('click', '.blog-details', readMore);
    }
})();
