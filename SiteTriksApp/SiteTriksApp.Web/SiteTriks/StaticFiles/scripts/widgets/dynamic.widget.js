...
export function dynamic() {
    function initDynamic(selectedClass, selectedType, selectedTemplate) {
        ...
        Data.getJson({ url: '/sitetriks/widgets/widgettemplates' }).then(function (res) {
            ...
            let $classes = $(document.createElement('select')).attr('id', 'dropdown-classes').addClass('form-control');
        ...
        $('#dynamic-container').on('change', '#dropdown-classes', function (ev) {
            ...
            let $types = $(document.createElement('select')).attr('id', 'dropdown-types').addClass('form-control');
        ...
        $('#dynamic-container').on('change', '#dropdown-types', function (ev) {
            ...
            let $templates = $(document.createElement('select')).attr('id', 'dropdown-templates').addClass('form-control');
